...
*/
/*ALTER DATABASE Best_Hospital_MBennett_Phase set single_user with rollback immediate
DROP DATABASE Best_Hospital_MBennett_Phase;
GO*/
CREATE DATABASE Best_Hospital_MBennett_Phase;
GO

USE Best_Hospital_MBennett_Phase;
